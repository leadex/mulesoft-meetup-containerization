...
(payload map {
	...
	postedDate: $.FinServ__PostDate__c,
	isDisputed: $.FinServ__IsDisputed__c as Boolean,
	disputedReason: AccountsTools::sfTransactionDisputedReasonToFins($.FinServ__DisputeReason__c),
	auditInfo: {
